...
//http://api.wordnik.com/v4/words.json/GET/words.json/search/food?&apiKey=94871e3858f326d228123973aa139af9a44b9fe9bc6f8890d
//const BASE_URL = 'http://api.wordnik.com/v4/word.json/';

//const BASE_URL = 'http://api.wordnik.com/v4/words.json/GET/words.json/search/{query}' + '&apiKey=' + apiKey;
...
// 'http://api.wordnik.com/v4/word.json/' + {word} + '/definitions?&api_key=94871e3858f326d228123973aa139af9a44b9fe9bc6f8890d'
